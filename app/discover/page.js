...
import { Activity, Pill, Dna, Clock, FileText, FlaskConical, HandCoins, Bookmark, Printer, Smile } from "lucide-react";
...
export default function MyJourneyPage() {
  ...
  const ITEMS = [
    ...
    { title: "Symptom Tracker", href: "/symptoms", icon: Smile, desc: "A quick daily check-in on how you're feeling" },
